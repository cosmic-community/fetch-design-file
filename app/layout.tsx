...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    // Changed: treasure map themed SEO defaults
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Changed: treasure map emoji favicon */}
      ...
      {/* Changed: warm parchment base background */}
      <body className="bg-parchment-50 text-amber-950">
        {children}
